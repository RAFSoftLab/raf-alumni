...
## 1. Alumni User
- **Primary Role**: Main users of the platform, consisting of Faculty graduates.
- **Responsibilities**:
  - Update personal, contact, and employment information.
  - Connect with other alumni.
  - Participate in groups and discussions.
  - Access job postings and engage in alumni events.
- **Access Rights**:
...
## 4. Employer/User from Partner Organizations
- **Primary Role**: Company representatives engaging with alumni.
- **Responsibilities**:
  - Post job opportunities.
  - View alumni profiles for recruitment.
