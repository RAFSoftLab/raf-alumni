...
admin.site.register(models.CourseScheduleEntry)
admin.site.register(models.CourseScheduleStudentSubscription)
admin.site.register(models.ExaminationPeriod)
admin.site.register(models.ExaminationEntry)